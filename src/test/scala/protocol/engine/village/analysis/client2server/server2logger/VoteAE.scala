...
import licos.protocol.engine.analysis.village.client2server.server2logger.VoteAnalysisEngine4Logger
...
final class VoteAE extends VoteAnalysisEngine4Logger {
  override def process(box: VillageBOX, vote: VoteProtocol4Logger): Try[VillageMessageProtocol] = {
    box match {
