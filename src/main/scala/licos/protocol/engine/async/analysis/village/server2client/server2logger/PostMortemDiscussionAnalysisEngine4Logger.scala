...
trait PostMortemDiscussionAnalysisEngine4Logger extends VillageMessageAnalysisEngine {
  @SuppressWarnings(Array[String]("org.wartremover.warts.ImplicitParameter"))
  def process(
      box:                  VillageBOX,
      postMortemDiscussion: PostMortemDiscussionProtocol4Logger
  )(implicit ec:            ExecutionContext): Future[Option[VillageMessageProtocol]]
}

object PostMortemDiscussionAnalysisEngine4Logger {
