...
import licos.protocol.element.village.server2client.GameResultProtocol as SimpleGameResultProtocol
import licos.util.TimestampGenerator
import play.api.libs.json.{JsValue, Json}

final case class GameResultProtocol4Logger(
    village:                    VillageInfo,
...
object GameResultProtocol4Logger {

  def read(json: JsonGameResult, villageInfoFromLobby: VillageInfoFromLobby): Option[GameResultProtocol4Logger] = {
    VillageInfoFactory
